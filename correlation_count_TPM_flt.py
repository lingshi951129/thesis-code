...
def main(argv):
    ...
    if countfile.find('wt') != -1:
        spre=sinputfile.replace(".txt","_wt_TPM_flt.txt")
    elif countfile.find('mut') != -1:
        spre=sinputfile.replace(".txt","_mut_TPM_flt.txt")
    ...
    del info[:]
    if countfile.find('wt') != -1:
        dpre=dinputfile.replace(".txt","_wt_TPM_flt.txt")
    elif countfile.find('mut') != -1:
        dpre=dinputfile.replace(".txt","_mut_TPM_flt.txt")
